...
class poseApp:
    ...
    EXERCISE_CFG = {
        "bicep_curl": {"up_angle": 5, "down_angle": 145, "l_parts": ['lshoulder', 'lelbow', 'lwrist'],
    ...
    def update_condition_timer(self, index):
        ...
        condition_met = (self.EXERCISE_CFG[self.exercise]["up_angle"] < self.angles[index] <
                         self.EXERCISE_CFG[self.exercise]["down_angle"])
